...
const METRICS = ["starts_total", "under_construction", "completions", "absorption_rate"];
const PRIMARY_METRIC = "starts_total";
  ...
  return (
    <div className="tab">
      ...
      <div className="card-grid">
        {snapshots.length === 0 && (
          <div className="tab__note">No supply pipeline data yet.</div>
        )}
        {snapshots.map((snap) => (
